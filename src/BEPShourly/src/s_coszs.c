...
void s_coszs(jday, j, lat, lon, CosZs) short jday,
    j; // j, hour of day
float lat, lon;
double *CosZs;
{
  ...
  Delta = 0.006918 - 0.399912 * cos(jday * 2.0 * 3.1415926 / 365.0) + 0.070257 * sin(jday * 2.0 * 3.1415926 / 365.0) - 0.006758 * cos(jday * 4.0 * 3.1415926 / 365.0) + 0.000907 * sin(jday * 4.0 * 3.1415926 / 365.0);
