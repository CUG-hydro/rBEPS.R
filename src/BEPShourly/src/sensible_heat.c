...
# include "beps.h"
void sensible_heat(
    //temperature of overstorey, understorey, sunlit and shaded
    ...
    double temp_air, double rh_air,
     // aerodynamic resistance of heat for each part
    double Gheat_o_sunlit, double Gheat_o_shaded, double Gheat_u_sunlit, double Gheat_u_shaded,
    double Gheat_g,
    double lai_o_sunlit, double lai_o_shaded, double lai_u_sunlit, double lai_u_shaded,  // lai
    double *SH_o, double *SH_u, double *SH_g)                                    // output sensible heat
{
