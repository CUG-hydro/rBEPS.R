...
double *trans_o, *trans_u;
{
    ...
    *trans_u =1/(latent_water )*(LHt_u_sunlit *lai_u_sunlit +LHt_u_shaded *lai_u_shaded );
    ...
    // printf("LHt_u_sunlit, LHt_u_shaded, lai_u_sunlit, lai_u_shaded: %.3f, %.3f, %.3f, %.3f\n", LHt_u_sunlit, LHt_u_shaded, lai_u_sunlit, lai_u_shaded);
    // printf("latent_water: %.3f, trans_o = %.3f, trans_u = %.3f\n", latent_water, *trans_o, *trans_u);
}
