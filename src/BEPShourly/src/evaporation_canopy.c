...
void evaporation_canopy(
    ...
    LHw_o_sunlit = percent_water_o * (vpd_air + slope_vapor_air * (tempL.o_sunlit - temp_air)) * density_air * cp_air * Gwater_o_sunlit / psy_air;
    LHw_o_shaded = percent_water_o * (vpd_air + slope_vapor_air * (tempL.o_shaded - temp_air)) * density_air * cp_air * Gwater_o_shaded / psy_air;

    LHw_u_sunlit = percent_water_u * (vpd_air + slope_vapor_air * (tempL.u_sunlit - temp_air)) * density_air * cp_air * Gwater_u_sunlit / psy_air;
    LHw_u_shaded = percent_water_u * (vpd_air + slope_vapor_air * (tempL.u_shaded - temp_air)) * density_air * cp_air * Gwater_u_shaded / psy_air;

    LHs_o_sunlit = percent_snow_o * (vpd_air + slope_vapor_air * (tempL.o_sunlit - temp_air)) * density_air * cp_air * Gwater_o_sunlit / psy_air;
    LHs_o_shaded = percent_snow_o * (vpd_air + slope_vapor_air * (tempL.o_shaded - temp_air)) * density_air * cp_air * Gwater_o_shaded / psy_air;

    LHs_u_sunlit = percent_snow_u * (vpd_air + slope_vapor_air * (tempL.u_sunlit - temp_air)) * density_air * cp_air * Gwater_u_sunlit / psy_air;
    LHs_u_shaded = percent_snow_u * (vpd_air + slope_vapor_air * (tempL.u_shaded - temp_air)) * density_air * cp_air * Gwater_u_shaded / psy_air;
