...
void Init_Soil_Parameters(int landcover, int stxt, double r_root_decay, struct Soil p[]) {
    ...
    switch (stxt) {
        case 1:  //sand
            ...
            p->Ksat[2] = 0.000046;
            p->Ksat[3] = 0.000035;
            p->Ksat[4] = 0.000010; /* saturated hydraulic conductivity */
            p->fei[0] = 0.437;
            p->fei[1] = 0.437;
            p->fei[2] = 0.437;
            p->fei[3] = 0.437;
            p->fei[4] = 0.437; /* porosity */
            p->theta_vfc[0] = 0.09;
            p->theta_vfc[1] = 0.09;
            p->theta_vfc[2] = 0.09;
            p->theta_vfc[3] = 0.09;
            p->theta_vfc[4] = 0.09; /* field capacity */
            p->theta_vwp[0] = 0.03;
            p->theta_vwp[1] = 0.03;
            p->theta_vwp[2] = 0.03;
            p->theta_vwp[3] = 0.03;
            p->theta_vwp[4] = 0.03; /* wilt point*/
            p->thermal_cond[0] = 8.6;
            p->thermal_cond[1] = 8.6;
            p->thermal_cond[2] = 8.6;
            p->thermal_cond[3] = 8.6;
            p->thermal_cond[4] = 8.6; /* thermal conductivity */
            p->psi_sat[0] = 0.07;
            p->psi_sat[1] = 0.08;
            p->psi_sat[2] = 0.09;
            p->psi_sat[3] = 0.10;
        ...
        case 7:  // clay loam
            ...
            p->theta_vwp[3] = 0.20;
            p->theta_vwp[4] = 0.20;
            p->thermal_cond[0] = 5.8;
            p->thermal_cond[1] = 5.8;
            p->thermal_cond[2] = 5.7;
            p->thermal_cond[3] = 5.8;
        ...
        case 8:  // silty clay loam
            ...
            p->Ksat[1] = 0.00000038;
            p->Ksat[2] = 0.00000034;
            p->Ksat[3] = 0.000000252;
            p->Ksat[4] = 0.000000084;
            p->fei[0] = 0.471;
            p->fei[1] = 0.471;
            p->fei[2] = 0.471;
            p->fei[3] = 0.471;
        ...
        case 9:  // sandy clay
            ...
            p->Ksat[0] = 0.00000033;
            p->Ksat[1] = 0.0000003;
            p->Ksat[2] = 0.000000264;
            p->Ksat[3] = 0.000000198;
            p->Ksat[4] = 0.000000066;
            p->fei[0] = 0.430;
            p->fei[1] = 0.430;
            p->fei[2] = 0.430;
            p->fei[3] = 0.430;
        ...
        case 11:  // clay
            ...
            p->b[4] = 8.4;
            p->Ksat[0] = 0.00000017;
            p->Ksat[1] = 0.000000153;
            p->Ksat[2] = 0.000000136;
            p->Ksat[3] = 0.000000102;
            p->Ksat[4] = 0.000000034;
            p->fei[0] = 0.475;
            p->fei[1] = 0.475;
            p->fei[2] = 0.475;
            p->fei[3] = 0.475;
